...
import com.example.store.dto.auth.AuthenticationRequest;
import com.example.store.dto.PasswordResetRequest;
import com.example.store.dto.auth.AuthenticationResponse;
...
import com.example.store.exception.PasswordConfirmationException;
import com.example.store.exception.PasswordException;
import com.example.store.mapper.AuthenticationMapper;
import com.example.store.security.UserPrincipal;
import com.example.store.utils.ControllerUtils;
